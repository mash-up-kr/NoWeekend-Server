...
enum class ErrorType(val status: HttpStatus, val code: ErrorCode, val message: String, val logLevel: LogLevel) {
    ...
    MCP_SERVER_TAGS_ERROR(HttpStatus.NOT_FOUND, ErrorCode.E404, "MCP 추천 서버에서 장애가 발생했습니다. 새로운 태그를 추천할 수 없습니다.", LogLevel.ERROR),
    USER_BIRTH_DAY_NOT_FOUND(HttpStatus.BAD_REQUEST, ErrorCode.E404, "사용자가 생일을 갖고있지 않습니다. 생일 먼저 추가해주세요.", LogLevel.WARN),
